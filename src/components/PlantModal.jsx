    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
        ...
        <motion.div
          ...
          className="relative w-full max-w-4xl bg-stone-50 rounded-[2.5rem] overflow-hidden shadow-2xl flex flex-col md:flex-row max-h-[90vh]"
        >
          <button
            onClick={onClose}
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 overflow-y-auto">
            ...
            <div className="space-y-8">
              <div>
                <h4 className="text-sm font-bold text-stone-900 uppercase tracking-widest mb-3">
                  Sobre esta planta
                </h4>
