      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-3xl">
          <motion.div
            ...
            className="flex items-center gap-2 text-emerald-600 font-bold text-xs uppercase tracking-[0.2em] mb-6"
          >
          ...
          <motion.h1
            ...
            className="text-6xl md:text-8xl font-serif font-bold text-stone-900 leading-[0.9] mb-8"
          >
            La Enciclopedia <br />
          ...
          <motion.p
            ...
            className="text-xl text-stone-600 leading-relaxed mb-10 max-w-xl"
          >
